...
exports.getFilenameByQuery = function(query, format, opt){
  
  
  if (query.viewport && (query.viewport == 'md' || query.viewport == 'sm')){
    
    return exports.getFilenameBySrc(query.src, format, [query.viewport]);
  }
  //For query.viewport == 'lg' we use default naming
  
   return exports.getFilenameBySrc(query.src, format, opt);
};
